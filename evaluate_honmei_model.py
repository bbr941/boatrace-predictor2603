...
def evaluate_honmei_metrics():
    ...
    # Load Model
    if not os.path.exists(MODEL_HONMEI):
        print(f"Model {MODEL_HONMEI} not found.")
        return
        
    model = lgb.Booster(model_file=MODEL_HONMEI)
    ...
    print("\n=== Honmei Model Performance (Test Set) ===")
